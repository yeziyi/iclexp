...
public class CleanMasterActivity extends Activity {
	...
	private Handler mHandler = new Handler(Looper.getMainLooper()) {
		public void handleMessage(android.os.Message msg) {
			...
			case MSG_UPDATE_SELECT:
				...
				mCleanButton.setText(getResources().getString(
						R.string.onekeyclean)
						+ " "
	...
	private TAIResponseListener mListener = new TAIResponseListener() {
		...
		public void onSuccess(TAResponse response) {
							...
							new TAIResponseListener() {
								...
								public void onRuning(TAResponse response) {
									...
									if (obj instanceof String) {
										mCleaning.setText(getResources()
			...
			String findSize = Formatter.formatShortFileSize(
					TAApplication.getApplication(), mTotalAPK + mTotalCache
							+ mTotalRAM + mTotalTrash + mTotalBig);
			String totalFindStr = String.format(
					getResources().getString(R.string.total_find), findSize);
			int start = totalFindStr.indexOf(findSize);
			int end = start + findSize.length();
			Spannable word = new SpannableString(totalFindStr);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adView.setAdUnitId("ca-app-pub-6335053266754945/9242251312");
